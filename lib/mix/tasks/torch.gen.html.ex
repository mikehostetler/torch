defmodule Mix.Tasks.Torch.Gen.Html do
  ...
  def run(args) do
    ...
    %{format: format, template_source: template_source} =
      Mix.Torch.parse_config!("torch.gen.html", args)
    ...
    Enum.each(@commands, &Mix.Torch.inject_templates(&1, format, template_source))
